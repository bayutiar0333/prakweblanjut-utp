...
<section style="background-color: #EEEEEE; height: 120vh; display: flex; justify-content: center; align-items: center;">
  <div class="container">
        ...
        <div class="card" style="border-radius: 15px; border: 1px solid #000;">
          <div class="card-body p-4">
            ...
            <form method="POST" action="<?= base_url('/user/' . $user['id']) ?>" enctype="multipart/form-data">
              ...
              <?= csrf_field() ?>
              <button class="btn btn-primary w-100 py-2 mt-3" type="submit">Update</button>
            </form>
          </div>
        </div>
      </div>
